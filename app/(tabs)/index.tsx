...
const HomeScreen = () => {
    ...
    // モーダルの種類を取得するコンテキスト
    const { ARObjectModalType, setARObjectModalType } =
        useARObjectModalContext();
    ...
    const handleStateChange = (event: any) => {
        ...
        switch (state) {
            ...
            case State.END: // 長押しをして指を離したとき
                const res: AbsoluteAreaEnum = whereAbsoluteArea(
                    absoluteX,
                    absoluteY
                );
    ...
    return (
        ...
        >
            <View style={styles.container}>
                ...
                {isLongPressEND &&
                ARObjectModalType != ARObjectModalEnum.None ? (
                    // ARオブジェクトモーダルを表示
                    <ARObjectModal />
                ) : null}
            </View>
